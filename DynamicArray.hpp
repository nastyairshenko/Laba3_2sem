#ifndef LAB3_2SEM_DYNAMICARRAY_HPP
#define LAB3_2SEM_DYNAMICARRAY_HPP
...
public:
    ...
    DynamicArray<T> *RemoveAt(int index) const {
        DynamicArray<T> *copy = new DynamicArray<T>(*this);
        copy->RemoveAt(index);
        return copy;
    }
    ...
    DynamicArray<T> *Remove(T value) const {
        DynamicArray<T> *copy = new DynamicArray<T>(*this);
        copy->Remove(value);
        return copy;
    }
...
#endif //LAB3_2SEM_DYNAMICARRAY_HPP
